...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LBASE] = LAYOUT(
    ...
    KC_LGUI,          LCTL_T(KC_A),     LALT_T(KC_S),       LGUI_T(KC_D),     LT(LF, KC_F),     KC_G,                       /* || */           KC_H,       LT(LJK, KC_J), RGUI_T(KC_K),     RALT_T(KC_L),   RCTL_T(KC_SCLN), KC_QUOT,
    KC_LSFT,          KC_Z,             KC_X,               KC_C,             LT(LF, KC_V),     KC_B,             KC_SPC,   /* || */  KC_ENT,  KC_N,       KC_M,          LT(LJK, KC_COMM), KC_DOT,         KC_SLSH,         KC_RSFT,
                                                                              KC_LCTL,          MO(LLAYER1),      KC_SPC,   /* || */  KC_ENT,  KC_RSFT,    KC_BSPC
  ),
  [LLAYER1] = LAYOUT(
  ...
  [LGAME] = LAYOUT(
    ...
    KC_LSFT,          KC_Z,             KC_X,               KC_C,             KC_V,             KC_B,             KC_SPC,   /* || */  KC_ENT,  KC_N,       KC_M,          KC_COMM,          KC_DOT,         KC_SLSH,         TO(LBASE),
                                                                              KC_LALT,          MO(LLAYER1),      KC_SPC,   /* || */  KC_ENT,  KC_RSFT,    KC_BSPC
  ),
  [LFKEYS] = LAYOUT(
...
const uint16_t PROGMEM combo2[] = {LALT_T(KC_S), LGUI_T(KC_D), COMBO_END};
const uint16_t PROGMEM combo3[] = {KC_UP, KC_RIGHT, COMBO_END};
const uint16_t PROGMEM combo4[] = {KC_E, LT(LF, KC_F), COMBO_END};
const uint16_t PROGMEM combo5[] = {KC_LGUI, LCTL_T(KC_A), COMBO_END};
const uint16_t PROGMEM combo6[] = {KC_LGUI, LCTL_T(KC_A), LALT_T(KC_S), COMBO_END};
const uint16_t PROGMEM combo7[] = {KC_Q, KC_W, COMBO_END};
const uint16_t PROGMEM combo8[] = {LT(LJK, KC_COMM), KC_DOT, COMBO_END};
const uint16_t PROGMEM combo9[] = {RGUI_T(KC_K), RALT_T(KC_L), COMBO_END};
...
const uint16_t PROGMEM combo13[] = {KC_C, LT(LF, KC_V), COMBO_END};
const uint16_t PROGMEM combo14[] = {KC_X, KC_C, LT(LF, KC_V), COMBO_END};
const uint16_t PROGMEM combo15[] = {LT(LF, KC_V), KC_B, COMBO_END};
...
const uint16_t PROGMEM combo18[] = {LT(LJK, KC_J), RALT_T(KC_L), COMBO_END};
...
const uint16_t PROGMEM combo22[] = {KC_M, LT(LJK, KC_COMM), COMBO_END};
